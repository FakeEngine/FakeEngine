...
/**
 *
 * The KeyTyped Event is being triggered if the User enters characters into a Textfield.
 *
 */
class FakeKeyTypedEvent : public FakeEvent
	{
	private:
		int32 KeyCode;
	...
	public:
		...
		/**
		 *
		 * The Constructor sets the KeyCode of the Key that was entered by the User into the Textfield.
		 *
		 * @param keyCode The KeyCode of the Key that was entered by the User into the Textfield.
		 */
		FakeKeyTypedEvent(int keyCode);

...
#include "Engine/Core/Events/FakeEvents.h"
 ...
 /**
  *
  * This Window class is a GLFW specific window class.
  *
  */
class FAKE_API FakeGLFWWindow : public FakeWindow
	{
	private:
		struct WNDPlacement
			{
	...
	public:
		...
		/**
		 *
		 * constructor that initializes a new GLFW window.
		 *
		 * @param title The title of the Window.
		 * @param width The Width of the Window.
		 * @param height The Height of the Window.
		 */
		FakeGLFWWindow(const FakeString &title, uint32 width, uint32 height);
		 ...
		 */
		FakeGLFWWindow(const FakeWindowData &data);
		...
		/**
		 *
		 * Getter for the actual window handle. The window handle is GLFW specific, therefore a void* is being returned.
		 *
		 * @return Returns the actual Window Handle. The Window Handle is GLFW specific.
		 */
		 ...
		 *
		 * @param view The View that is going to be added to the Window.
		 */

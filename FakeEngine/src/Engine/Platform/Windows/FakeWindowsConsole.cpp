...
int32 FakeWindowsConsole::ConvertForeground(FakeConsoleForeground foreground)
	{
	switch (foreground)
		{
...
int32 FakeWindowsConsole::ConvertBackground(FakeConsoleBackground background)
	{
	switch (background)
		{
